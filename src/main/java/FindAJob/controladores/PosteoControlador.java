...
//        model.addAttribute("posteo", new Posteo());  //envio un nuevo posteo a la vista
        return "/testMAFBEnd/p/cliente-lista-test.html";
    }
    ...
    public String enviarPosteoForm(ModelMap model,
        ...
        return "/testMAFBEnd/p/cliente-post-test.html";
    }
    ...
    public String procesarPosteoForm(
            ...
            @RequestParam(required = false) String rubro) throws ErrorServicio {
        ...
        try {
            ...
            posteo.setProfesion(profesionServicio.entregarUnaProfesionAleatoriaSegunRubro(rubro));
